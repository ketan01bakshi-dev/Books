...
A place to gather what books — and courses — leave behind, then see it whole.

## The Wisdom Bridge

[Daaji Kamlesh D. Patel](https://en.wikipedia.org/wiki/Kamlesh_Patel_(Daaji)) — *The Wisdom Bridge: Nine Principles to a Life that Echoes in the Hearts of Your Loved Ones*

Open the living map: [the-wisdom-bridge/index.html](the-wisdom-bridge/index.html)
...
- List methods: append, extend, remove, reverse, sort, index (Core Types & Foundations)
- In-place list mutation vs new lists (Inductive Definitions & Recursion)
- for-else search: findpos, break vs normal termination (Inductive Definitions & Recursion)
...
- Merge sort: halves + linear merge (Divide & Conquer Sorting)
